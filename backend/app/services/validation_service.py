...
class ValidationService:
    ...
    async def discover_from_point(self, page: Page, x: float, y: float) -> ValidationDiscoveryResponse:
    ...
    def _match_catalog_entries(self, snapshot: ValidationElementSnapshot, catalog: ValidationCatalog) -> list[Any]:
        scored_entries: list[tuple[int, Any]] = []
        ...
        return [entry for score, entry in scored_entries if score == best_score]
