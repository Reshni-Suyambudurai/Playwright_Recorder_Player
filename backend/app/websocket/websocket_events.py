...
class EventType:
    ...
    VALIDATION_DISCOVERED = "VALIDATION_DISCOVERED"
    # Assertions (visibility, text, value modes)
    ASSERTION_MODE_TOGGLED = "ASSERTION_MODE_TOGGLED"
    ASSERTION_HOVER = "ASSERTION_HOVER"
    ASSERTION_DISCOVERED = "ASSERTION_DISCOVERED"
    ASSERTION_STEP_RECORDED = "ASSERTION_STEP_RECORDED"
    ASSERTION_SAVED = "ASSERTION_SAVED"
    # Snapshot assertions (region-based ARIA snapshot)
    SNAPSHOT_CAPTURE_REQUEST = "SNAPSHOT_CAPTURE_REQUEST"
    SNAPSHOT_PREVIEW = "SNAPSHOT_PREVIEW"
    SNAPSHOT_SAVE_ASSERTION = "SNAPSHOT_SAVE_ASSERTION"
